...
def upgrade() -> None:
    ...
    # Add new columns to accounts table (no batch needed for additions)
    ...
    # Create index for is_active if it doesn't exist (may already exist from previous migration)
