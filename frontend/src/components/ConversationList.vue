    ...
    <div class="p-4 border-b border-instagram-border bg-white">
      <div class="flex items-center justify-between">
        ...
        <button
          ...
          :class="{ 'opacity-50 cursor-wait': syncing }"
          :disabled="syncing"
          :title="syncing ? 'Syncing from Instagram...' : 'Sync messages from Instagram'"
        >
          <svg
            :class="['w-5 h-5 text-gray-600 transition-transform', { 'animate-spin': syncing }]"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
